...
def listar_tareas():
    vst.mostrar_mensaje("-> Listado de Tareas")
...
def consultar_tarea():
    vst.mostrar_mensaje("-> Consultar Tarea")
...
def adicionar_tarea():
    vst.mostrar_mensaje("-> Adicionando Tarea")        
...
def actualizar_tarea():
    vst.mostrar_mensaje("-> Actualizar Tarea")
...
def eliminar_tarea():
    vst.mostrar_mensaje("->Eliminar Tarea")
