...
def read(id: int = None) -> dict or list:
    ...
    Parametros:
    -----------
        id (int) [Opcional]: Identificacion de la tarea a consultar. Por defecto, el valor es None.
...
def update(id: int, tarea_actualizada: dict) -> dict :
    ...
    Parametros:
    -----------
        id (int): Identificacion de la tarea a consultar.
...
def delete(id: int) -> dict:
    ...
    Parametros:
    -----------
        id (int): Identificacion de la tarea a eliminar.
...
def obtener_tarea(id: int) -> dict or list:
    ...
    Lanza:
    -----------
        Exception: Excepcion lanzada si ocurre un error en el proceso
    """
